...
import 'package:delivery_ecommerce/controller/orders/acceptedOrders_Controller.dart';
import 'package:delivery_ecommerce/controller/orders/pendingOrders_Controller.dart';
                      ...
                      // Text("Status : ${controller.printOrderStatus(listdata.status.toString())}"),
                       ...
                       Row(
                        ...
                        //    ),
                           ...
                           onPressed: (){
                                       // controller.deleteOrder(listdata.id.toString());
                                        controller.doneOrdersDelivery(listdata.id.toString(), listdata.userId.toString());
